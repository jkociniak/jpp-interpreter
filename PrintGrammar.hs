...
instance Print (Program a) where
  prt i e = case e of
    Prog _ decls -> prPrec i 0 (concatD [prt 0 decls])

instance Print (Block a) where
  prt i e = case e of
    Blk _ decls stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 decls, prt 0 stmts, doc (showString "}")])

instance Print (Decl a) where
  prt i e = case e of
    VarDecl _ type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString ";")])
...
instance Print (Arg a) where
  prt i e = case e of
    ValArg _ type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
    RefArg _ type_ id -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&"), prt 0 id])
  prtList _ [] = (concatD [])
...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    Interrupt _ inter -> prPrec i 0 (concatD [prt 0 inter, doc (showString ";")])
