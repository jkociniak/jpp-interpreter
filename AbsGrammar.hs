...
-- the module consists of two parts, the first is generated by bnfc and the second consists of my helper definitions
...
getExprPos :: Expr Position -> Position
...
getInterPos :: Inter Position -> Position
getInterPos (Break pos) = pos
getInterPos (Continue pos) = pos